...
Examples:
1. <code>{escape('<b>@fondness_mov</b>')}</code> 
This will give output of:
<b>@fondness_mov</b>  <code>50MB.bin</code>.

2. <code>{escape('<code>@fondness_mov</code>')}</code> 
This will give output of:
<code>@fondness_mov</code> <code>50MB.bin</code>.
